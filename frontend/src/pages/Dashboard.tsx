    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center gap-2 mb-4">
          <h2 className="text-base font-bold text-brand">Fleet Overview</h2>
          <span className="text-xs font-medium px-2 py-0.5 rounded-md bg-white text-signal-dark border border-signal-light/50">
            Preview
          </span>
        </div>
      ...
      <GlassCard className="p-5" delay={0.3}>
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            <h3 className="text-sm font-bold text-brand">Start with Equipment Master Data</h3>
