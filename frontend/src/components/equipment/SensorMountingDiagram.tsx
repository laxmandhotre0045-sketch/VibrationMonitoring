...
export function SensorMountingDiagram({ orientations = {} }: SensorMountingDiagramProps) {
  ...
  return (
    <div className="flex flex-col items-center">
      <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">Mounting Orientation Reference</p>
      ...
      <div className="flex gap-4 mt-2">
        <div className="flex items-center gap-1">
          ...
          <span className="text-xs text-gray-500">NDE</span>
        </div>
        <div className="flex items-center gap-1">
