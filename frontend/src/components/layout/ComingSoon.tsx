  ...
  return (
    <div>
      ...
      <GlassCard className="card-pad text-center">
        ...
        >
          <div className="w-20 h-20 rounded-xl bg-white border border-border flex items-center justify-center mb-g4">
          ...
          {features.length > 0 && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 w-full mb-g5">
